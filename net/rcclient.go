...
func NewRcClient(protocol,addr string) *Client{
	return &RcClient{protocol:protocol,addr:addr}
}
...
func (this *RcClient) SendTimeOut(timeout time.Duration,msg interface{}) ( []byte,error){
